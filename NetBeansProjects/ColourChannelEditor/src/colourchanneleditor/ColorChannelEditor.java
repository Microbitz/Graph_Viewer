 ...
 * @author Kuta
 */
public class ColorChannelEditor extends javax.swing.JFrame {
...
model.addRow(new Object[]{Fechas[u],Horas[u],valores1[u],valores2[u],valores3[u],valores4[u]});
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ColorChannelEditor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ColorChannelEditor().setVisible(true);
            }
        });
    }
